...
//    var// MINI_PHOTOS_DIRECTORY = context.environment.isWindows === true ? "c:\\temp\\49photos\\" : '/tmp/49photos/';
    ...
    var jeffUserId = configuration.dev.myFoursquareUserId; // '20057'; // my foursquare account number.
...
// res.session.destroy(function(err) { } );
    ...
    app.configure(function() {
        ...
        var mongoCredentials = require('./mongoCredentials')(configuration.mongo.sessionsConnectionString);
        ...
        app.use(express.session({ 
            ...
            store: new MongoStore({
                db : mongoCredentials.db,
                host : mongoCredentials.server,
                port : mongoCredentials.port,
                username: mongoCredentials.user,
    ...
    app.get('/v1/push/status.html', function (req, res) {
        ...
        res.send('<html><body>Push notifications are release but this page does not have much more inforamtion currently, sorry. Tweet to @4thandmayor for assistance.</body></html>');
    });
