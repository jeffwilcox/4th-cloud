...
function initializeMongo(context, callback) { // (err)
    ...
    // TODO: Refactor this to not be chainy and nasty.
            ...
            if(err) {
                ...
                mongoClient.collection(mongoClientsTable, function(err, col) {
                    if(err) {
                        ...
                        // mongoClientsCollection = col;
                        mongoClient.collection(mongoHistoryTable, function(err, col) {
                            if(err) {
                                callback(err);
                            }
                            else {
                                context.mongo.collections.history = col;
                                // mongoHistoryCollection = col;
...
module.exports = function(config, role, mode, logger, callback) {
