...
module.exports = function (role, mode) {
	...
	nconf //.argv()
	      // .env()
	      .file('ec2', { file: filename, dir: '/home/ec2-user/4th-cloud/'})
	      .file('local', { file: filename, dir: '.'})
	      .file('conf', { file: filename, dir: path.resolve('../4th-conf/')});

//	     .file({ file: '/home/ec2-user/4th-cloud/' + filename })
//	     .file({ file: path.resolve('../4th-conf/' + filename) })
//	     .file({ file: './' + filename });
	     
	nconf.load();
	
	console.dir(nconf.stores);
